...
import Cart_2 from "../../assets/images/card_2.png";
...
const AuthLayout = ({ children }) => {
  return (
    <div className="flex">
      ...
      <div className="hidden md:block w-[40vw] h-screen bg-violet-50 bg-auth-bg-img bg-cover bg-no-repeat bg-center p-8 relative overflow-hidden">
        <div className="w-48 h-48 rounded-[40px] bg-purple-600 absolute -top-7 -left-5" />
        <div className="w-48 h-56 rounded-[40px]  border-fuchsia-600 absolute bottom-7 top-[30%] -right-10"></div>
